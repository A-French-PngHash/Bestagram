...
class Description {
    ...
    private func getReducedDescriptionFrom(description : String) -> String{
        ...
        while description.count > index && description[index] != " " && Post.minimumCharacterReducedDescription - index <= 10 {
            index += 1
        }
        ...
        if index == description.count {
            ...
            // The programm doesn't add it here as it needs to be in a different color and it can't do that if it's all in the same string.
        }
    }
